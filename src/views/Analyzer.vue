<template>
  <div class="animated fadeIn">
        ...
        <b-card no-body class="bg-primary">
          <b-card-body class="pb-0">
            <b-dropdown class="float-right" variant="transparent p-0" right>
              ...
              <b-dropdown-item>Show Charts</b-dropdown-item>
    ...
    <b-card>
      <b-row>
        <b-col sm="5">
          <h4 id="traffic" class="card-title mb-0">Gold</h4>
          <div class="small text-muted">{{date}}</div>
        </b-col>
        <b-col sm="7" class="d-none d-md-block">
          <b-button type="button" variant="primary" class="float-right"><i class="icon-cloud-download"></i></b-button>
          <b-button-toolbar class="float-right" aria-label="Toolbar with buttons group">
            <b-form-radio-group class="mr-3" id="radiosBtn" buttons button-variant="outline-secondary" v-model="chartTimeRange" name="radiosBtn">
              <b-form-radio class="mx-0" value="Day">Day</b-form-radio>
              <b-form-radio class="mx-0" value="Week">Week</b-form-radio>
      ...
      <!-- vue组件模版tag和组件ID对应 -->
      <gold-analy-chart chartId="main-chart-01" class="chart-wrapper" style="height:300px;margin-top:40px;" height="300"></gold-analy-chart>
      <div slot="footer">
...
<script>
import GoldAnalyChart from './analyzer/GoldAnalyChart'
import CardLine1ChartExample from './analyzer/CardLine1ChartExample'
import CardLine2ChartExample from './analyzer/CardLine2ChartExample'
import CardLine3ChartExample from './analyzer/CardLine3ChartExample'
...
import GoldAnalyChartVue from './analyzer/GoldAnalyChart.vue';
...
export default {
  ...
  watch:{
    chartTimeRange:{
      handler(current,old){
        GoldAnalyChart.refresh(current);
      }
    }
  }
}
